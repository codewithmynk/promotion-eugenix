    ...
    <div class="hero-slider">
        <div class="items">
                    ...
                    <div class="hero-caption">
                        <div class="relative">
                            ...
                            <div class="btnbox d-flex wow fadeInLeft" data-wow-delay="0.4s">
                                <a class="btn white-btn big ml-auto" href="<?php echo $banner_button_link; ?>"><span><?php echo $banner_button_label; ?> <i class="las la-arrow-right"></i></span></a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="caption-imgbox d-flex">
                <img src="<?php echo esc_url($banner_image['url']); ?>" alt="<?php echo $banner_image['title']; ?>">
            </div>
            <?php endif; ?>
...
<section class="media-section ptb-30 bg4">
    <div class="container">
        ...
        <div class="media-list media-slider wow fadeInUp" data-wow-delay="0.3s">
            ...
            <?php if($media_logo): ?>
            <div class="items">
                <a class="card-media" href="<?php echo $media_link; ?>" target="_blank">
                    <div class="imgbox">
...
<section class="results-section bg4">
    <div class="container">
                    ...
                    <div class="row results-list results-slider ptb-20 wow fadeInRight" data-wow-delay="0.3s">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 items">
                            <div class="card-result shine">
                                <div class="imgbox">
                                    <img src="<?php echo esc_url($results_beforeafter_image['url']); ?>" alt="<?php echo $results_beforeafter_image['title']; ?>">
                                </div>
...
<section class="hair-ls-section bg1 ptb-60">
    ...
    <div class="container relative">
        ...
        <div class="block-title text-center ptb-20 pt-0 wow fadeInUp" data-wow-delay="0.2s">
            <h2 class="text-white"><?php echo $hair_loss_solution_section_title; ?></h2>
        </div>
        <?php endif; ?>
        ...
        <div class="hair-ls-block">
            ...
            <div class="row v-center">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12 right-block">
                    <div class="imgbox">
                        <img src="<?php echo esc_url($hair_loss_block_image['url']); ?>" alt="<?php echo $hair_loss_block_image['title']; ?>">
                    </div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="service-list-tab row serv-slider-nav">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 items">
                    <div class="card-serv-icon">
                        <?php if($service_icon): ?>
                        <i class="iconbox"><img src="<?php echo esc_url($service_icon['url']); ?>" alt="<?php echo $service_name; ?>"></i>
                        <?php endif; ?>
                        ...
                        <div class="row serv-text-inner">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 right-block">
                                <div class="serv-text-imgbox">
                                    <img src="<?php echo esc_url($service_image['url']); ?>" alt="<?php echo $service_image['title']; ?>">
                                </div>
                            </div>
                            <?php endif; ?>
    ...
    <div class="container relative">
        ...
        <div class="block-title row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 left-block wow fadeInLeft" data-wow-delay="0.2s">
                <h2><?php echo $procedure_section_title; ?></h2>
            </div>
            <?php endif; ?>
            ...
            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 items wow fadeInLeft" data-wow-delay="0.<?php echo $pro_count; ?>s">
                <div class="card-procedure">
                    ...
                    <i class="iconbox d-flex v-center j-center">
                        <img src="<?php echo esc_url($procedure_block_icon['url']); ?>" alt="<?php echo $procedure_block_icon['title']; ?>">
                    </i>
                    <?php endif; ?>
        ...
        <div class="counter-list d-flex">
            ...
            <div class="items">
                <div class="card-counter d-flex v-center">
                    ...
                    <?php if($counter_icon): ?>
                    <i class="iconbox d-flex v-center j-center">
                        <img src="<?php echo esc_url($counter_icon['url']); ?>" alt="<?php echo $counter_text; ?>">
                    </i>
                    <?php endif; ?>
...
<section class="india-section ptb-60">
    ...
    <div class="container relative">
        ...
        <div class="block-title text-center ptb-20 pt-0 wow fadeInUp" data-wow-delay="0.2s">
            <?php if($india_section_title): ?>
            <h2><?php echo $india_section_title; ?></h2>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="row results-inner">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 right-block">
                <div class="results-right-inn pl-0">
                    ...
                    <div class="block-title wow fadeInRight" data-wow-delay="0.2s">
                        <h2><?php echo $journey_section_title; ?></h2>
                    </div>
                    <?php endif; ?>
...
<section class="journey-section results-section ptb-60">
    <div class="container relative">
        
        <?php if($video_testimonial_section_title): ?>
        <div class="block-title text-center wow fadeInUp" data-wow-delay="0.2s">
            <h2><?php echo $video_testimonial_section_title; ?></h2>
        </div>
        <?php endif; ?>

        <?php if(have_rows('video_testimonial_block')) : ?>
        <div class="row video-test-list ptb-20">
            <?php $v_count=0; ?>
...
<section class="testimonial-section bg1 ptb-60">
    ...
    <div class="container relative">
        ...
        <div class="block-title wow fadeInUp" data-wow-delay="0.2s">
            <h2 class="text-white"><?php echo $testimonials_section_title; ?></h2>
        </div>
        <?php endif; ?>
...
?>
<?php if($consult_sec_image || $consult_sec_title || $consult_sec_text ): ?>
...
<!--                         <script data-b24-form="inline/182/b7bieo" data-skip-moving="true">(function(w,d,u){var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0);var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);})(window,document,'https://eugenixcity.com/upload/crm/form/loader_182_b7bieo.js');</script> -->
                    </div>
...
<section class="endorsement-section media-section ptb-60">
    <div class="container">
...
jQuery(document).ready(function(){
    ...
    jQuery(".video-btn").click(function(){
        var vid = jQuery('#videoplayid').val();
        var videoplaysrc = jQuery('#videoplaysrc').val();
        if(videoplaysrc !== '' && vid !== '') {
            jQuery('#videoBox_'+vid).find('iframe').attr('src', videoplaysrc);
            jQuery('#videoBox_'+vid).parent().removeClass('active');
        }
        jQuery('.v-big-list .items').addClass('hide');
        var vid = jQuery(this).attr('id');
        var videosrc = jQuery('#videoBox_'+vid).removeClass('hide');
        var videosrc = jQuery('#videoBox_'+vid).find('iframe').attr('src');
        jQuery('#videoplayid').val(vid);
        jQuery('#videoplaysrc').val(videosrc);
        jQuery('#videoBox_'+vid).find('iframe').attr('src', videosrc+'?autoplay=1');
        jQuery('#videoBox_'+vid).addClass('active');
        jQuery('#videoBox_'+vid).parent().addClass('active');
    });
    ...
    jQuery(window).scroll(function() {
        var bTop_bar = jQuery('.counter-block').offset().top - window.innerHeight;
